var obApiCallerCointiger = async function (exchangeCurrencyPair) {
  ...
  var obMapperFunction = function(json, exchangeCurrencyPair, convertPrice) {
    ...
    // bid : buy
    var bidOrders = parseOrderCointiger(json, "buys", exchangeCurrencyPair, convertPrice);
  
    // ask : sell
    var askOrders = parseOrderCointiger(json, "asks", exchangeCurrencyPair, convertPrice);
...
function parseOrderCointiger(json, bidOrAsk, exchangeCurrencyPair, convertPrice) {
